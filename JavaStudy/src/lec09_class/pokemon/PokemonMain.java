...
public class PokemonMain {
	public static void main(String[] args) {
		...
		pokemonPool.add(new Pokemon("어니부기","물대포x2",75,300,Constants.TYPE_WATER,75));
		pokemonPool.add(new Pokemon("거북왕","하이드로펌트",100,400,Constants.TYPE_WATER,100));
		pokemonPool.add(new Pokemon("이상해씨","덩쿨채",50,200,Constants.TYPE_PLANT,50));
		pokemonPool.add(new Pokemon("이상해풀","씨앗발싸",75,300,Constants.TYPE_PLANT,75));
